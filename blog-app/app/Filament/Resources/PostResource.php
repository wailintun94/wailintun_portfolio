        ...
        return $form
            ->schema([
                ...
                Section::make('Meta')->schema([
                    ...
                    DateTimePicker::make('publish_at')->nullable()->required(),
                    Checkbox::make('featured'),
                    Select::make('user_id')->relationship('author', 'name')->searchable()->required(),
                    Select::make('categories')->multiple()->relationship('categories', 'category')->searchable(),
                ])
            ]);
    }
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                TextColumn::make('publish_at')->date()->sortable()->searchable(),
